...
create table konta (
    ...
    numer_telefonu int,
    haslo varchar(250),
    foreign key (imie) references klienci (imie),
    foreign key (nazwisko) references klienci (id_administrator),
    foreign key (id_numer_kierunkowy) references klienci (id_numer_kierunkowy),
    foreign key (numer_telefonu) references klienci (numer_telefonu),
