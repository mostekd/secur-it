            ...
            <div class="services">
                <?php
                    while($row = mysqli_fetch_assoc($data))
                    {
                        ...
                        <button class='delete'><a href=admin_databases.php?del=True&id_service=".$row['id_service'].">
                        Usuń usługę
                        </a></button>
                        <button class='delete'><a href=databases_edit.php?id_service=".$row['id_service'].">
                        Edytuj usługę
                        </a></button>
                        </div>";
                    }
