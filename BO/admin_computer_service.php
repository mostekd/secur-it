            ...
            <div class="services">
                ...
                <?php
                    while($row = mysqli_fetch_assoc($data))
                    {
                        ...
                        <button class='delete'><a href=admin_computer_service.php?del=True&id_service=".$row['id_service'].">
                        Usuń usługę
                        </a></button>
                        <button class='delete'><a href=computer_service_edit.php?id_service=".$row['id_service'].">
                        Edytuj usługę
                        </a></button>
                        </div>";
                    }
