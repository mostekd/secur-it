            ...
            <div class="services">
                <?php
                    while($row = mysqli_fetch_assoc($data))
                    {
                        ...
                        <button class='delete'><a href=admin_websites.php?del=True&id_service=".$row['id_service'].">
                        Usuń usługę
                        </a></button>
                        <button class='delete'><a href=websites_edit.php?id_service=".$row['id_service'].">
                        Edytuj usługę
                        </a></button>
                        </div>";
                    }
